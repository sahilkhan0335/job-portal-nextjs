...
- **Session Security** for authenticated route access
  ...
  - Added atomic transaction in registerUserAction
  - Ensures user, role (applicant/employer), and session data are inserted safely
  - Prevents partial inserts on error (rollback supported)
  - Strengthens data integrity and consistency across related tables
